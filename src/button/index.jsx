...
var Button = (function (_super) {
    ...
    Button.prototype.render = function () {
        ...
        if (this.props.addonLeft || this.props.addonRight) {
            ...
            addon = (<i className={addonClass}></i>);
        }
        // loading
        ...
        if (this.props.loading === true) {
            ...
            loadingComponent = (<div className={loadingClass}>
        ...
        return (<button onClick={this.handleClick.bind(this)} className={btnClass} {...src_1.others(new module.Props(), this.props)}>
